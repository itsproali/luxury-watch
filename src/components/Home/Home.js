        ...
        <div className='mx-4 md:mx-16'>
            <div className='grid grid-cols-1 md:grid-cols-2 items-center'>
                ...
                <div className="home-text">
                    ...
                    <button className="font-medium px-4 py-2 bg-pink-200 text-pink-500 cursor-pointer rounded hover:bg-pink-300 hover:text-pink-700 ease-in-out duration-300">Explore Now</button>
                </div>
            </div>
